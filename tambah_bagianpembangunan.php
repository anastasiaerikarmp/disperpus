...
if (isset($_POST['tambahdata'])) {
    ...
    // buat query
    $sql = "INSERT INTO administrasi (no, kode_klasifikasi, no_box, no_berkas, uraian, tahun, jumlah, ket, file) VALUES ('$no','$kode_klasifikasi', '$no_box', '$no_berkas', '$uraian', '$tahun', '$jumlah', '$ket', '$file_name')";
