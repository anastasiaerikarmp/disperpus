...
if (isset($_POST['tambahdata'])) {
    ...
    // buat query
    $sql = "INSERT INTO perencanaan (no, kode_klasifikasi, no_box, no_berkas, uraian, tahun, jumlah, ket, file) VALUES ('$no','$kode_klasifikasi', '$no_box', '$no_berkas', '$uraian', '$tahun', '$jumlah', '$ket', '$file_name')";
  ...
  if( $query ) {
    ...
    header('Location: adminperencanaan.php');
  } else {
