...
if(isset($_POST['updatedata'])){
  ...
  // buat query update
  $sql = "UPDATE tarutung SET no='$no', kode_klasifikasi='$kode_klasifikasi', no_box='$no_box', no_berkas='$no_berkas', uraian='$uraian', tahun='$tahun', jumlah='$jumlah',ket='$ket', file='$file_name' WHERE no=$no";
